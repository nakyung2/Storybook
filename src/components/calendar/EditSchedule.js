...
import {Box, Button, Fade, FormControl, InputLabel, MenuItem, Popover, Select, TextField} from '@mui/material'
...
export default function EditSchedule(props) {
    ...
    return (
        <Popover id={id} open={open} anchorEl={anchorEl} 
            elevation={3} transition placement="bottom-end"
            onClose={handleClose}
            sx={{zIndex: 5}}
        >
            {({ TransitionProps }) => (
              <Fade {...TransitionProps} timeout={350}>
                <Box sx={{
                    ...
                    <div style={{marginTop: 0, marginBottom: "20px"}}>
                        <span style={{marginLeft: "50px"}}>일정 수정</span>
